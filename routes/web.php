...
Route::post('/user/pg_password', [UserController::class, 'vw_pg_password'])->name('user.pg_password');
Route::get('/user/pg_password', [UserController::class, 'vw_pg_password'])->name('user.pg_password');
Route::post('/user/password', [UserController::class, 'vw_password'])->name('user.password');
Route::get('/user/password', [UserController::class, 'vw_password'])->name('user.password');
Route::post('/pg_login', [UserController::class, 'vw_pg_login'])->name('user.pg_login')->withoutMiddleware(UserLoggedIn::class);
Route::get('/pg_login', [UserController::class, 'vw_pg_login'])->name('user.pg_login')->withoutMiddleware(UserLoggedIn::class);
Route::post('/login', [UserController::class, 'vw_login'])->name('user.login')->withoutMiddleware(UserLoggedIn::class);
Route::get('/login', [UserController::class, 'vw_login'])->name('user.login')->withoutMiddleware(UserLoggedIn::class);
