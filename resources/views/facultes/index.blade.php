            ...
            <div class="row justify-space-between pb-4">
                ...
                <div class="col d-flex justify-content-end">
                    ...
                    <dialog style="border: 2px solid white; border-radius: 4px; width: 520px" id="add-modal">
                        ...
                        <hr />
                        <form action="{{ route('facultes.store') }}" method="POST">
                            @csrf
                            <div class="mt-4">
                                <label for="code">Code</label>
                                <input type="text" class="form-control" name="code" placeholder="Code de la faculté"
                                    required>
                            </div>
                            <div class="mt-4">
                                <label for="libelle">Libellé</label>
                                <input type="text" class="form-control" name="libelle"
                                    placeholder="Liblllé de la faculté" required>
                            </div>
                            <div class="mt-4">
